...
# Part 1
tokens1 = tokenise1(file_string)
print(len(tokens1))
unique_tokens1=unique_tokens(tokens1)
print(len(unique_tokens1))
print( "Types (unique tokens) / token ratio:",len(tokens1)/len(unique_tokens1))
